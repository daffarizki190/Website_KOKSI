...
app.post("/api/auth/login", async (req, res) => {
  try {
    ...
    const isDemoMatch = cleanNoHp === "081234567890" && password === "admin123" || cleanNoHp === "081222333444" && password === "user123" || cleanNoHp === "081299998888" && password === "it123456";
    let isValid = false;
    if (isDemoMatch) {
      isValid = true;
    } else {
...
// api/index.ts
var seedTriggered = false;
var triggerColdStartSeed = () => {
  if (!seedTriggered) {
    seedTriggered = true;
