      ...
      <div className="flex flex-col items-center gap-6 px-6 max-w-sm w-full">
        ...
        <div className="text-center mt-2 mb-2">
          <p className="text-white/60 text-xs leading-relaxed max-w-[260px]">
            Harap tunjukkan QR Code ini ke petugas Koperasi untuk dipindai. Barcode hanya dapat digunakan <strong className="text-white">1 kali</strong>.
          </p>
        </div>

        {/* Timer */}
        {expiresAt && (
          <div className={`w-full flex items-center justify-between px-5 py-3 rounded-2xl ${
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col text-left">
                <p className="text-white/50 text-[10px] uppercase tracking-widest font-bold">
                  {isExpired ? 'Status' : 'Berlaku sampai'}
                </p>
                {secondsLeft === null && (
